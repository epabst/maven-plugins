...
/**
 * Tests <code>CollectTreeMojo</code>.
 *
 ...
 * @since 2.0
 */
public class TestCollectTreeMojo
    extends AbstractDependencyMojoTestCase
{
        ...
        throws Exception
    {
        ...
        CollectTreeMojo mojo = (CollectTreeMojo) lookupMojo( "tree", testPom );
    ...
    public void _testTreeDotSerializing()
        throws Exception
    {
        List<String> contents = runCollectTreeMojo("tree1.dot", "dot");
    ...
    public void _testTreeGraphMLSerializing()
        throws Exception
    {
        List<String> contents = runCollectTreeMojo("tree1.graphml", "graphml");
    ...
    public void _testTreeTGFSerializing()
        throws Exception
    {
        List<String> contents = runCollectTreeMojo("tree1.tgf", "tgf");
     ...
     */
    private List<String> runCollectTreeMojo(String outputFile, String format)
             throws Exception
    {
        File testPom = new File( getBasedir(), "target/test-classes/unit/tree-test/plugin-config.xml" );
